...
namespace ClubeVideo
{
    public partial class Funcionarios : Form
    {
        ...
        public Funcionarios(int empresa)
        {
        ...
        private void loadFuncionarios()
        {
            ...
            cmd.Parameters.AddWithValue("@Cod_loja", (object)DBNull.Value);
        ...
        public bool salvarLoja()
        {
            ...
            if (criar)
            {
                ...
                {
                    listBoxFuncionarios.Items.Add(L);
                    new Lojas_do_Funcionario(L.Cod_Funcionario).Show();
                }
            }
            else
            {
        ...
        private bool submeterLoja(Funcionario L)
        {
            int rows = 0;
            ...
            cmd.CommandText = "EXEC ClubeVideo.pr_criarFuncionario @Cod_Funcionario, @Nome_Funcionario, @Data_Nascimento, @Nacionalidade, @Sexo, @Estado_Civil, @Telemovel, @E_mail, @Vencimento, @Data_Admissao, @Cod_endereco, @Cod_Situacao, @Cod_profissao, @Cod_tipo_pagamento, @NIF, @NIB, @No_doc_identificacao, @Cod_empresa";
        ...
        private void buttonLojas_Click(object sender, EventArgs e)
        {
            ...
            {
                Visible = false;
                Lojas_do_Funcionario lojas = new Lojas_do_Funcionario(textBoxCod_Funcionario.Text.ToString());
